...
MIN_FREQ = 1  # all6979，tra_all:6871, tra:6741, 5：5928/all:6038
reset_vocab = False
    ...
    def load_dataset(path, pad_size=32):
        ...
        with open(path, 'r', encoding='UTF-8') as f:
            for line in tqdm(f):
                ...
                words_line = [vocab[w] for w in token if w in vocab]
...
if __name__ == "__main__":
    ...
    if os.path.exists(vocab_dir):
        ...
        word_to_id = build_vocab(train_dir, tokenizer=tokenizer, max_size=MAX_VOCAB_SIZE, min_freq=MIN_FREQ)
