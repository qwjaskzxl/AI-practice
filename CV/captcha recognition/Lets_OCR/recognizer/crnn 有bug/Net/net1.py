...
class CNN(nn.Module):
    ...
    def __init__(self, imageHeight, nChannel):
        ...
        self.depth_conv0 = nn.Conv2d(in_channels=3, out_channels=3, kernel_size=3, stride=1, padding=1,
                                     groups=3)
        self.point_conv0 = nn.Conv2d(in_channels=3, out_channels=64, kernel_size=1, stride=1, padding=0,
                                     groups=1)
