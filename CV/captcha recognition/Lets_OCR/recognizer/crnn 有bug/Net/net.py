...
class Vgg_16(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.convolution1 = torch.nn.Conv2d(3, 64, 3, padding=1) # old channle:1
...
class RNN(torch.nn.Module):
    def __init__(self, class_num, hidden_unit):
        ...
        # self.fc = torch.nn.Linear(hidden_unit * 2, hidden_unit)
