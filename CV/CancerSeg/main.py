...
def parse_args():
    ...
    parser.add_argument('--model-state-dict-path', default='results/model-', type=str, help='model_state_dict_path')
    ...
    parser.add_argument('--imgSize', default=192, type=int)
    parser.add_argument('--pretrain-dim', type=int, default=300, help='')
    parser.add_argument('--train-data', type=str, default='/home1/lihaoyuan/AI-practice/CV/CancerSeg/data/original/', help='')
    parser.add_argument('--val-data', type=str, default='/home1/lihaoyuan/AI-practice/CV/CancerSeg/data/original/', help='')
    parser.add_argument('--test-data', type=str, default='/home1/lihaoyuan/AI-practice/CV/CancerSeg/data/original/', help='')
    # parser.add_argument('--label-path', type=str, default='/home1/lihaoyuan/data/CV/CancerSeg/data/target', help='')
    parser.add_argument('--data-rate', type=float, default=0.3, help='')
    parser.add_argument('--cls-num', default=2, type=int)
    ...
    parser.add_argument('--display-n-batches', type=int, default=10, help='')
...
def main(args):
    ...
    # args.load_pretrained_model = args.evaluate = 1

    print(args, end='\n\n')

    os.environ['CUDA_VISIBLE_DEVICES'] = str(args.g)

    from runner_CS import Runner
    runner = Runner(args)
    if args.train:
        runner.train()
    if args.evaluate:
